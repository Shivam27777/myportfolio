...
const Icons = {
  ...
  leetCode: (props: IconProps) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg"  fill="currentColor" className="bi bi-caret-down" viewBox="0 0 32 32">
...
const DATA = {
  ...
  contact: {
    social: {
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/shivamsingh271999/",
        icon: Icons.linkedin,
      },
      LeetCode: {
      ...
      email: {
        name: "Send Email",
        url: "mailto:shivam27777@gmail.com",
        icon: Icons.email,
      },
    },
  },
